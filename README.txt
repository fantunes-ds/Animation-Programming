1. Press Play
2. If you want to change the animation speed, use 'Y' to slow it down, use 'U' to go faster.
3. If you want to switch between animations, you can use 'O' to go to Walking animation, 'I' to use Running animation.

Note : The animation doesn't cycle perfectly seamlessly. We skip the last frame so it doesn't slow down the overall animation, 
